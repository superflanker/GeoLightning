...
from GeoLightning.Runners.RunnerLSA import runner_LSA


def test_runner_LSA(fake_test=False):
    ...
    for r in range(runs):
        ...
        (sol_centroides_espaciais,
            ...
            crlb_temporal,
            execution_time,
            associacoes_corretas) = runner_LSA(event_positions,
                                               event_times,
                                               spatial_clusters,
                                               sensor_tt,
                                               sensor_indexes,
    ...
    if fake_test:
        ...
        """
        paper_data = np.array(paper_data)
        output_file = os.path.join(basedir, "LSA_results.npy")
