...
from GeoLightning.Runners.RunnerFHO import runner_FHO


def test_runner_FHO(fake_test=False):
    ...
    for r in range(runs):
        ...
        (sol_centroides_espaciais,
            ...
            delta_t_refinado,
            execution_time,
            associacoes_corretas) = runner_FHO(event_positions,
                                               event_times,
                                               spatial_clusters,
                                               sensor_tt,
                                               sensor_indexes,
    ...
    if fake_test:
        ...
        """
        paper_data = np.array(paper_data)
        output_file = os.path.join(basedir, "FHO_results.npy")
