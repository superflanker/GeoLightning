...
from GeoLightning.Runners.RunnerGA import runner_GA


def test_runner_GA(fake_test=False):
    ...
    if fake_test:
        ...
        """
        paper_data = np.array(paper_data)
        output_file = os.path.join(basedir, "GA_results.npy")
