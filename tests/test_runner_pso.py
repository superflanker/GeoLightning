...
from GeoLightning.Runners.RunnerPSO import runner_PSO
...
def test_runner_PSO(fake_test=False):
    ...
    if fake_test:
        ...
        """
        paper_data = np.array(paper_data)
        output_file = os.path.join(basedir, "PSO_results.npy")
